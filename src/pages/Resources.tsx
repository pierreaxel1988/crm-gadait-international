...
const Resources = () => {
  return <div className="min-h-screen bg-loro-50">
      <Navbar />
      <SubNavigation />
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-loro-navy font-medium text-lg">Resources</h1>
        </div>

        <div className="space-y-8">
          {resources.map(countryResource => <div key={countryResource.country}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {countryResource.folders.map(folder => <a key={folder.language} href={folder.url} target="_blank" rel="noopener noreferrer" className="block">
