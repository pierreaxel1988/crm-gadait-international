  ...
  return <Card className="bg-white shadow-luxury">
      ...
      <CardContent>
        <div className="flex flex-wrap gap-2">
          ...
          return <button key={category.value} onClick={() => toggleFilter(category.value)} className={`flex items-center gap-2 rounded-full py-1 px-3 text-sm font-medium transition-all ${isActive ? 'ring-2 ring-loro-terracotta ring-offset-1' : 'opacity-70 hover:opacity-100'}`} style={{
