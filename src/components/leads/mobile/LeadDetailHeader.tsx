...
const LeadDetailHeader: React.FC<LeadDetailHeaderProps> = ({
  ...
  const headerClasses = "flex items-center justify-between p-3 w-full bg-[#0A2540] text-white";
  ...
  return <div className={headerClasses}>
      ...
      <div className="flex flex-col items-end gap-2 flex-shrink-0">
        <div className="flex items-center gap-2">
          {phone && <>
              <button onClick={handlePhoneClick} className="h-8 w-8 flex items-center justify-center rounded-full bg-gradient-to-r from-white/10 to-white/5 border border-white/20 transition-all duration-200 hover:bg-gradient-to-r hover:from-white/20 hover:to-white/10 hover:scale-110" aria-label="Appeler">
                <Phone className="h-4 w-4 text-white" />
              </button>
              <button onClick={handleWhatsAppClick} className="h-8 w-8 flex items-center justify-center rounded-full bg-gradient-to-r from-white/10 to-white/5 border border-white/20 transition-all duration-200 hover:bg-gradient-to-r hover:from-white/20 hover:to-white/10 hover:scale-110" aria-label="WhatsApp">
                <svg 
          ...
          {email && <button onClick={handleEmailClick} className="h-8 w-8 flex items-center justify-center rounded-full bg-gradient-to-r from-white/10 to-white/5 border border-white/20 transition-all duration-200 hover:bg-gradient-to-r hover:from-white/20 hover:to-white/10 hover:scale-110" aria-label="Email">
