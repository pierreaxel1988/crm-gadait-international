...
const LeadForm = ({ lead, onSubmit, onCancel, activeTab = 'informations' }: LeadFormProps) => {
  ...
  const renderGeneralInformationFields = () => (
  ...
  const renderSearchCriteriaFields = () => (
    <div className="space-y-4">
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid gap-6 md:grid-cols-1">
        {activeTab === 'informations' && renderGeneralInformationFields()}
        {activeTab === 'criteres' && renderSearchCriteriaFields()}
        {activeTab === 'statut' && renderStatusFields()}
      </div>
