  ...
  return (
    ...
    >
          ...
          {lead.phone && (
            <div className="flex items-center text-sm text-muted-foreground mt-1 gap-2">
              ...
              <button 
                ...
                className="h-6 w-6 flex items-center justify-center rounded-full bg-gradient-to-r from-loro-sand/30 to-loro-pearl/30 border border-loro-sand/50 transition-all duration-200 hover:shadow-sm hover:scale-105"
                aria-label="Contacter via WhatsApp"
              >
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  className="h-3 w-3 text-loro-navy"
                  viewBox="0 0 50 50"
                  fill="currentColor"
                >
      ...
      <div className="mt-4 flex space-x-2">
        <CustomButton 
          variant="outline" 
          className="flex-1 text-loro-navy border-loro-sand hover:bg-loro-sand/10 font-futura"
        ...
        <button
          ...
          className="flex-1 bg-gradient-to-r from-loro-navy to-loro-navy/90 hover:from-loro-navy/90 hover:to-loro-navy/80 text-white px-4 py-2 rounded-lg font-futura text-sm font-medium transition-all duration-200 flex items-center justify-center gap-2 shadow-sm hover:shadow-md"
        >
