...
import { Home, Activity, Trash2, FolderOpen, Trophy } from 'lucide-react';
...
const getStatusLabel = (status: LeadStatus, pipelineType: PipelineType): string => {
  ...
  const statusLabels: Record<string, string> = {
    ...
    'Signed': isOwners ? 'Mandat signé' : (pipelineType === 'rental' ? 'Dépôt reçu' : 'Signature finale'),
    ...
    >
      ...
      <div className="space-y-4">
        ...
        {(lead.pipelineType === 'purchase' || lead.pipelineType === 'rental') && (
          <div className="space-y-2">
            <Label htmlFor="googleDriveLink" className="text-sm">Lien KYC (Google Drive)</Label>
            <div className="flex">
              <div className="flex-shrink-0 flex items-center justify-center w-10 h-10 border border-r-0 rounded-l-md bg-white">
