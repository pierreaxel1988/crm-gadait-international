  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label className="text-sm">Type de mandat</Label>
          <div className="flex items-center space-x-2 p-3 bg-white border rounded-md">
            <div className="flex-shrink-0 flex items-center justify-center w-6 h-6 mr-2">
              <FileCheck className="h-4 w-4 text-gray-500" />
            </div>
            <RadioGroup 
              value={lead.mandate_type || 'simple'} 
              onValueChange={(value) => handleInputChange('mandate_type', value)}
              className="flex space-x-4"
            >
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="simple" id="simple" />
                <Label htmlFor="simple" className="text-sm font-futura cursor-pointer">Simple</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="exclusif" id="exclusif" />
                <Label htmlFor="exclusif" className="text-sm font-futura cursor-pointer">Exclusif</Label>
              </div>
            </RadioGroup>
          </div>
        </div>
