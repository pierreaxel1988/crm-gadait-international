...
import { Building2, MapPin, Bed, Bath, Maximize2, ExternalLink, Star, ChevronLeft, ChevronRight } from 'lucide-react';
...
interface SuggestedPropertyCardProps {
  property: GadaitProperty;
  leadId: string;
}

const SuggestedPropertyCard: React.FC<SuggestedPropertyCardProps> = ({ property, leadId }) => {
