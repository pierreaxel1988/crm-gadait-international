...
const SearchCriteriaSection = ({
  ...
  return <div className="space-y-4 py-[20px]">
      ...
      {lead.pipelineType === 'owners' ? <div className="space-y-6">
          <Tabs defaultValue="budget" className="w-full" onValueChange={setActiveTab}>
            ...
            <TabsContent value="location" className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="google_drive_link" value={lead.google_drive_link || ''} onChange={e => onDataChange({
              google_drive_link: e.target.value
            })} placeholder="Coller le lien Google Drive du dossier complet" className="font-futura" />
        ...
        </div> : <BuyerCriteriaSection lead={lead} onDataChange={onDataChange} />}
    </div>;
};
