...
export function AIActionSuggestions({ lead, onActionAdded }: AIActionSuggestionsProps) {
  ...
  if (isLoading) {
    return (
      <div className="border rounded-md p-2 bg-loro-pearl/20 flex flex-col items-center justify-center animate-[fade-in_0.3s_ease-out]">
        <Loader2 className="h-4 w-4 text-loro-navy animate-spin mb-1" />
  ...
  if (error) {
    return (
      <div className="border rounded-md p-2 bg-red-50 animate-[fade-in_0.3s_ease-out]">
        ...
        <div className="flex justify-center">
          <Button 
            ...
            variant="outline"
            size="sm"
            className="text-xs border-red-200 text-red-600 hover:bg-red-50 h-7 py-0"
          >
  ...
  if (!suggestions || suggestions.length === 0) {
    return (
      <div className="border rounded-md p-2 bg-loro-pearl/20 text-center animate-[fade-in_0.3s_ease-out]">
        <Lightbulb className="h-4 w-4 text-loro-navy/60 mx-auto mb-1" />
        <p className="text-xs text-loro-navy/80 mb-1">Aucune suggestion pour le moment</p>
        <Button 
          onClick={handleManualRefresh}
          variant="outline" 
          size="sm"
          className="text-xs border-loro-navy text-loro-navy hover:bg-loro-pearl/20 w-full h-7 py-0"
        >
          <RefreshCw className="h-3 w-3 mr-1" />
