        ...
        {phone && <>
            <Tooltip>
              <TooltipTrigger asChild>
                <button onClick={(e) => startCall('phone', e)} className="h-7 w-7 flex items-center justify-center rounded-full bg-gradient-to-r from-loro-sand/20 to-loro-pearl/20 border border-loro-sand/30 transition-all duration-200 hover:shadow-sm hover:scale-110" aria-label="Appeler">
                  <Phone className="h-3.5 w-3.5 text-loro-navy" />
                </button>
              </TooltipTrigger>
              <TooltipContent>
                <p>Appeler</p>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button onClick={(e) => startCall('whatsapp', e)} className="h-7 w-7 flex items-center justify-center rounded-full bg-gradient-to-r from-loro-sand/20 to-loro-pearl/20 border border-loro-sand/30 transition-all duration-200 hover:shadow-sm hover:scale-110" aria-label="WhatsApp">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    className="h-3.5 w-3.5 text-loro-navy"
                    viewBox="0 0 50 50"
                    fill="currentColor"
                  >
          ...
          {email && <Tooltip>
            <TooltipTrigger asChild>
              <button onClick={handleEmailClick} className="h-7 w-7 flex items-center justify-center rounded-full bg-gradient-to-r from-loro-sand/20 to-loro-pearl/20 border border-loro-sand/30 transition-all duration-200 hover:shadow-sm hover:scale-110" aria-label="Email">
                <Mail className="h-3.5 w-3.5 text-loro-navy" />
              </button>
            </TooltipTrigger>
            <TooltipContent>
              <p>Email</p>
