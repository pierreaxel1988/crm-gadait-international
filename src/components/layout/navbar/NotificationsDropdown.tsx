...
const NotificationsDropdown = () => {
  ...
  return <TooltipProvider>
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent ref={popoverRef} className="w-84 p-0 bg-loro-white rounded-lg shadow-luxury border-0" align="end" sideOffset={10}>
          <div className="py-2.5 px-4 bg-gradient-to-r from-loro-terracotta to-loro-hazel text-white rounded-t-lg flex justify-between items-center bg-loro-terracotta">
